class ZCL_ZHR_ESS_VAC_LIM_MPC definition
  public
...
TT_ENTITYCHECK type standard table of TS_ENTITYCHECK. .
  types:
     TS_ENTITYSAVE type ZVACATION_APPLICATION. .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_LIM_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_LIM_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_LIM_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20171012073524'.                  "#EC NOTEXT
