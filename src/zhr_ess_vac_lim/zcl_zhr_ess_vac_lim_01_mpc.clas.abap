class ZCL_ZHR_ESS_VAC_LIM_01_MPC definition
  public
...
public section.
  ...
  types:
     TS_ENTITYMAIN type ZVACATION_LIMIT. .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_LIM_01_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_LIM_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_LIM_SRV_01' ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LimitBegda' iv_abap_fieldname = 'LIMIT_BEGDA' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 8 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LimitEndda' iv_abap_fieldname = 'LIMIT_ENDDA' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 8 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AvailableDays' iv_abap_fieldname = 'AVAILABLE_DAYS' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UsedDays' iv_abap_fieldname = 'USED_DAYS' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LimitDays' iv_abap_fieldname = 'LIMIT_DAYS' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVACATION_LIMIT'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200321095205'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'AvailableDays'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'UsedDays'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'LimitDays'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
