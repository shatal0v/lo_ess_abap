class ZCLHR_ESS_INCOME_INFO_MPC definition
  public
...
public section.
  ...
  types:
     TS_REVIEW type ZSHR_ESS_WS_INCOMEINFO_REVIEW. .
  types:
TT_REVIEW type standard table of TS_REVIEW. .
  types:
  ...
  types:
  begin of TS_FILE,
     MAIN_USER type C length 12,
     ENTRANCE_USER type C length 12,
     YEAR type C length 4,
     FILENAME type SSTRING,
     REQID type CHAR32,
  end of TS_FILE. .
  types:
TT_FILE type standard table of TS_FILE. .
  ...
  constants GC_REVIEW type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Review' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCLHR_ESS_INCOME_INFO_MPC=====CP' ##NO_TEXT.

  methods DEFINE_REVIEW
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_FILE
    raising
...
CLASS ZCLHR_ESS_INCOME_INFO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_INCOME_INFO_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLHR_ESS_INCOME_INFO_MPC=>TS_FILE' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Review' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DeclNeed' iv_abap_fieldname = 'DECL_NEED' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StatusTxt' iv_abap_fieldname = 'STATUS_TXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'File' iv_abap_fieldname = 'FILE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DateEnd' iv_abap_fieldname = 'DATE_END' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DateCreate' iv_abap_fieldname = 'DATE_CREATE' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MsgId' iv_abap_fieldname = 'MSG_ID' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Hrcomment' iv_abap_fieldname = 'HRCOMMENT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSHR_ESS_WS_INCOMEINFO_REVIEW'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ReviewSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200415095529'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'DeclNeed'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Review'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DateEnd'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Review'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DateCreate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Review'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Hrcomment'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Review'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
