*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHRV_AWART_COLOR
*   generation date: 31.01.2018 at 11:18:59
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHRV_AWART_COLOR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHRV_AWART_COLOR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHRV_AWART_COLOR_EXTRACT
TOTAL = ZHRV_AWART_COLOR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHRV_AWART_COLOR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHRV_AWART_COLOR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRV_AWART_COLOR_EXTRACT
TOTAL = ZHRV_AWART_COLOR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHRV_AWART_COLOR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHRV_AWART_COLOR'
...
TOTAL = ZHRV_AWART_COLOR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHRV_AWART_COLOR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHRV_AWART_COLOR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHRV_AWART_COLOR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHRV_AWART_COLOR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRV_AWART_COLOR_EXTRACT
TOTAL = ZHRV_AWART_COLOR_TOTAL
