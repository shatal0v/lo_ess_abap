class ZCL_ZHR_ESS_VAC_DEL_AP_MPC definition
  public
...
public section.
  ...
  types:
     TS_VACAPPLICATION type ZMSS_VACATION_APPLICATION. .
  types:
TT_VACAPPLICATION type standard table of TS_VACAPPLICATION. .
  types:
  ...
  constants GC_VACAPPLICATION type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VacApplication' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_DEL_AP_MPC====CP' ##NO_TEXT.

  methods DEFINE_VACAPPLICATION
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZHR_ESS_VAC_DEL_AP_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_DEL_APP_SRV' ).

define_vacapplication( ).
  endmethod.


  method DEFINE_VACAPPLICATION.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - VacApplication
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VacApplication' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VacApplicationSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200329201123'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'VacApplication'.                            "#EC NOTEXT
