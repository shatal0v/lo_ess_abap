class ZCL_ZHR_ESS_VAC_GET_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_VACAPPLICATION,
     REQUESTID type CHAR100,
     ABSTEXT type string,
     BEGDA type string,
     ENDDA type string,
     PERNR type string,
     FIO type string,
     COMMENT type string,
     NEXTHANDLERFIO type string,
     MAINUSER type string,
     ENTRANCEUSER type C length 64,
  end of TS_VACAPPLICATION. .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_GET_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_GET_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_GET_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'REQUESTID' iv_abap_fieldname = 'REQUESTID' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'AbsText' iv_abap_fieldname = 'ABSTEXT' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NextHandlerFIO' iv_abap_fieldname = 'NEXTHANDLERFIO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHR_ESS_VAC_GET_MPC=>TS_VACAPPLICATION' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200417113935'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'REQUESTID'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'AbsText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VacApplication'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'FIO'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VacApplication'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'NextHandlerFIO'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VacApplication'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
