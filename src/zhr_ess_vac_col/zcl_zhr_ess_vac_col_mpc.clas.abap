class ZCL_ZHR_ESS_VAC_COL_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_ENTITYMAIN,
     AWART type C length 4,
     STATUS type C length 12,
     STATUSTEXT type string,
     ATEXT type string,
     COLOR type C length 10,
  end of TS_ENTITYMAIN. .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_COL_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_COL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_COL_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Awart' iv_abap_fieldname = 'AWART' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StatusText' iv_abap_fieldname = 'STATUSTEXT' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AwartText' iv_abap_fieldname = 'ATEXT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHR_ESS_VAC_COL_MPC=>TS_ENTITYMAIN' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20171017140709'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Awart'.                 "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'StatusText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'AwartText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityMain'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
