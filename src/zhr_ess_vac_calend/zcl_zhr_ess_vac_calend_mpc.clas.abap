class ZCL_ZHR_ESS_VAC_CALEND_MPC definition
  public
...
TT_ENTITYABS type standard table of TS_ENTITYABS. .
  ...
  begin of TS_HOLIDAY,
     ...
     TYPE type string,
     TEXT type string,
     ENTRANCEUSER type C length 64,
     MAINUSER type C length 64,
  end of TS_HOLIDAY. .
  types:
TT_HOLIDAY type standard table of TS_HOLIDAY. .
  ...
  constants GC_HOLIDAY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Holiday' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_CALEND_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_CALEND_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_CALEND_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Holiday' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHR_ESS_VAC_CALEND_MPC=>TS_HOLIDAY' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HolidaySet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200226070622'.                  "#EC NOTEXT
