class ZCL_ZHR_ESS_VAC_GET_LI_MPC definition
  public
...
TT_ENTITYMAIN type standard table of TS_ENTITYMAIN. .
  ...
  types:
  begin of TS_ENTITYABS,
     AWART type C length 4,
     ATEXT type C length 200,
...
TT_ENTITYABS type standard table of TS_ENTITYABS. .
  types:
     TS_ENTITYLIMIT type ZVACATION_LIMIT_TYPE. .
  types:
TT_ENTITYLIMIT type standard table of TS_ENTITYLIMIT. .

  constants GC_ENTITYABS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'EntityAbs' ##NO_TEXT.
  constants GC_ENTITYLIMIT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'EntityLimit' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHR_ESS_VAC_GET_LI_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZHR_ESS_VAC_GET_LI_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHR_ESS_VAC_GET_LIM_ABS_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'ALimit' "#EC NOTEXT
                            iv_left_type        = 'EntityMain' "#EC NOTEXT
                            iv_right_type       = 'EntityLimit' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'AAbs' "#EC NOTEXT
                            iv_left_type        = 'EntityMain' "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NavLimit' "#EC NOTEXT
                                                              iv_abap_fieldname = 'NAVLIMIT' "#EC NOTEXT
                                                              iv_association_name = 'ALimit' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Atext' iv_abap_fieldname = 'ATEXT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHR_ESS_VAC_GET_LI_MPC=>TS_ENTITYABS' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'EntityLimit' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Ktart' iv_abap_fieldname = 'KTART' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Klong' iv_abap_fieldname = 'KLONG' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 200 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVACATION_LIMIT_TYPE'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'EntityLimitSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200226080017'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Atext'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'EntityAbs'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
