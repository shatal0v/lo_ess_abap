*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_EDU_PROGRAM
*   generation date: 09.04.2020 at 13:36:12
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_EDU_PROGRAM    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_EDU_PROGRAM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_EDU_PROGRAM_EXTRACT
TOTAL = ZVHR_EDU_PROGRAM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_EDU_PROGRAM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_EDU_PROGRAM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_EDU_PROGRAM_EXTRACT
TOTAL = ZVHR_EDU_PROGRAM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_EDU_PROGRAM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_EDU_PROGRAM'
...
TOTAL = ZVHR_EDU_PROGRAM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_EDU_PROGRAM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_EDU_PROGRAM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVHR_EDU_PROGRAM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVHR_EDU_PROGRAM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_EDU_PROGRAM_EXTRACT
TOTAL = ZVHR_EDU_PROGRAM_TOTAL
