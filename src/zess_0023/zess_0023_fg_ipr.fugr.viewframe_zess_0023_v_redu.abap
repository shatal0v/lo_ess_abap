*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZESS_0023_V_REDU
*   generation date: 14.04.2020 at 10:30:20
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZESS_0023_V_REDU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_REDU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZESS_0023_V_REDU_EXTRACT
TOTAL = ZESS_0023_V_REDU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_REDU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZESS_0023_V_REDU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_REDU_EXTRACT
TOTAL = ZESS_0023_V_REDU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZESS_0023_V_REDU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_REDU'
...
TOTAL = ZESS_0023_V_REDU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZESS_0023_V_REDU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZESS_0023_V_REDU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_REDU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZESS_0023_V_REDU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_REDU_EXTRACT
TOTAL = ZESS_0023_V_REDU_TOTAL
