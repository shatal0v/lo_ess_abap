*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZESS_0023_V_FEDU
*   generation date: 31.01.2020 at 18:18:38
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZESS_0023_V_FEDU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_FEDU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZESS_0023_V_FEDU_EXTRACT
TOTAL = ZESS_0023_V_FEDU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_FEDU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZESS_0023_V_FEDU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_FEDU_EXTRACT
TOTAL = ZESS_0023_V_FEDU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZESS_0023_V_FEDU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_FEDU'
...
TOTAL = ZESS_0023_V_FEDU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZESS_0023_V_FEDU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZESS_0023_V_FEDU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_FEDU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZESS_0023_V_FEDU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_FEDU_EXTRACT
TOTAL = ZESS_0023_V_FEDU_TOTAL
