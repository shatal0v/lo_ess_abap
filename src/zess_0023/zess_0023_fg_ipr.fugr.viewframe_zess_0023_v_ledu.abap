*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZESS_0023_V_LEDU
*   generation date: 13.04.2020 at 18:00:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZESS_0023_V_LEDU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_LEDU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZESS_0023_V_LEDU_EXTRACT
TOTAL = ZESS_0023_V_LEDU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_LEDU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZESS_0023_V_LEDU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_LEDU_EXTRACT
TOTAL = ZESS_0023_V_LEDU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZESS_0023_V_LEDU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_LEDU'
...
TOTAL = ZESS_0023_V_LEDU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZESS_0023_V_LEDU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZESS_0023_V_LEDU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZESS_0023_V_LEDU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZESS_0023_V_LEDU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZESS_0023_V_LEDU_EXTRACT
TOTAL = ZESS_0023_V_LEDU_TOTAL
